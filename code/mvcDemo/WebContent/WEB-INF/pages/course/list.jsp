				...
				<div style="padding: 5px">
					...
					<ul>
						<li><a
							...
							href="<c:url value='/course/exportExcelTemplate.do'/>">导出课程模板</a></li>
						<li><a
							class="waves-effect waves-light btn modal-trigger  green accent-4  right"
							href="#courseModal">导入数据</a></li>
						<li><a
							class="waves-effect waves-light btn green accent-4 right"
							href="<c:url value='/course/exportExcel.do'/>">导出数据</a></li>
						<li><a
							class="waves-effect waves-light btn green accent-4 right"
							href="<c:url value='/course/enterAdd.do'/>">添加</a></li>
					</ul>
				</div>
				<div style="padding-top: 35px">
					<div id="table-datatables">
						<table id="data-table-course" class="responsive-table display"
							cellspacing="0">
							<thead>
							...
							<tbody>
								<c:forEach items="${courseList}" var="item" varStatus="s">
									<tr>
										...
										<td align="center" valign="middle"><a
											...
											href="<%=basePath %>/teacher/enterEdit/${item.id}.do">修改</a>
											&nbsp;&nbsp;&nbsp; <a
											class="waves-effect waves-light btn cyan accent-4 left"
											href="<%=basePath %>/teacher/deleteTeacher/${item.id}.do">删除</a>
											&nbsp;&nbsp;&nbsp; <a
											class="waves-effect waves-light btn cyan accent-4 left"
											href="<%=basePath %>/teacher/enterDetail/${item.id}.do">详细</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
				...
				<div id="modal-fixed-footer">
					<div class="row">
						<div class="col s12 m8 l9">
							<div id="courseModal" class="modal  green white-text">
								<div class="modal-content">
									<!--Input File Input-->
									<div id="input-file-input" class="section">
										<h4 class="header">导入课程数据</h4>
										<div class="row">
											<div class="col s12 m8 l9">
												<form id="importForm" name="importForm"
													action="<c:url value='/course/importExcel.do'/>"
