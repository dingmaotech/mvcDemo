...
<link href="<c:url value='/frame/css/prism.css'/>" type="text/css"
	rel="stylesheet" media="screen,projection">
<link
...
<body class="cyan">
	...
	<div id="login-page" class="row">
		<div class="col s12 z-depth-4 card-panel">
			<form id="loginForm" class="login-form" method="post"
				action="<c:url value='/loginAction/login.do'/>">
				<div class="row">
					<div class="input-field col s12 center">
						<img src="<c:url value='/frame/images/login-logo.png'/>" alt=""
				...
				<div class="row">
					<div class="input-field col s12">
						<a class="btn waves-effect waves-light col s5"
							href="javascript:submitForm()">登录</a> <a
	...
	<!--prism-->
	<script type="text/javascript"
		src="<c:url value='/frame/js/prism.js'/>"></script>
	<!--scrollbar-->
	<script type="text/javascript"
