...
<meta name="description" content="添加系统教师信息">
<meta name="keywords" content="教师，添加教师">
<!-- For iPhone -->
<meta name="msapplication-TileColor" content="#00bcd4">
<meta name="msapplication-TileImage"
	content="<c:url value='/frame/images/favicon/mstile-144x144.png'/>">
<!-- For Windows Phone -->
<title>教学管理系统-添加教师</title>
<!-- Favicons-->
<link rel="icon"
	...
	<div id="login-page" class="row">
		<div class="col s12 z-depth-4 card-panel">
			<form class="login-form" id="addForm" name="addForm" method="post"
				action="<c:url value='/teacher/save.do'/>">
				<div class="row">
				...
				<div class="row margin">
					<div class="input-field col s12">
						<i class="mdi-social-person-outline prefix"></i> <label for="name"
							class="center-align ">教师名：</label> <input id="teachername"
							name="name" type="text">
					</div>
				</div>
				<div class="row">
