				...
				<div style="padding: 5px">
					...
					<ul>
						<li><a
							...
							href="<c:url value='/teacher/exportExcelTemplate.do'/>">导出教师模板</a></li>
						<li><a
							class="waves-effect waves-light btn modal-trigger accent-4  green right"
							href="#studentModal">导入数据</a></li>
						<li><a
							class="waves-effect waves-light btn green accent-4 right"
							href="<c:url value='/teacher/exportExcel.do'/>">导出数据</a></li>
						<li><a
							class="waves-effect waves-light btn green accent-4 right"
							href="<c:url value='/teacher/enterAdd.do'/>">添加</a></li>
					</ul>
				</div>
				<div style="padding-top: 35px">
					<div id="table-datatables">
						<table id="data-table-teacher" class="responsive-table display"
							cellspacing="0">
							<thead>
							...
							<tbody>
								<c:forEach items="${teacherList}" var="item" varStatus="s">
									<tr>
							...
							<div id="studentModal" class="modal  green white-text">
								<div class="modal-content">
									...
									<div id="input-file-input" class="section">
										<h4 class="header">导入教师数据</h4>
										<div class="row">
											<div class="col s12 m8 l9">
												<form id="importForm" name="importForm"
													action="<c:url value='/teacher/importExcel.do'/>"
