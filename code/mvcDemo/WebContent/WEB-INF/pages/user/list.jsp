...
/* 	  $('#data-table-user tfoot th').each( function () {
	      var title = $('#data-table-user thead th').eq( $(this).index() ).text();
    ...
    var usertable = $('#data-table-user').DataTable({
        "bProcessing": true,
  	    ...
  	    "aoColumns": [
  	    { "sClass": "center", "sName": "id","mDataProp": "id" },
  	    { "sClass": "center", "sName": "username","mDataProp": "username"  } , 
  	    { //自定义列
  	    "sName": "id",
  	    "mDataProp": "id" ,
  	    "sClass": "center",
  	    ...
  	    return '<a  href=\"/user/enterEdit/' + obj.aData[0] + '\.do">编辑</a> ' + '<a  href=\"/user/deleteUser/' + obj.aData[0] + '\.do">删除</a> ';
  	       }} 
  	    ],
        language: {
            "sProcessing":   "处理中...",
