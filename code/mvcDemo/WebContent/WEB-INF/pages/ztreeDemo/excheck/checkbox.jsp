					...
					<ul class="list">
						...
						<li><p>
								父子关联关系：<br /> 被勾选时：<input type="checkbox" id="py"
									class="checkbox first" checked="checked" /><span>关联父</span> <input
									type="checkbox" id="sy" class="checkbox first"
									checked="checked" /><span>关联子</span><br /> 取消勾选时：<input
									type="checkbox" id="pn" class="checkbox first"
									checked="checked" /><span>关联父</span> <input type="checkbox"
									id="sn" class="checkbox first" checked="checked" /><span>关联子</span><br />
