...
public class ExcelTitleVo {
	...
	public ExcelTitleVo(String title, String secondTitle, String sheetName) {
		this.title = title;
	...
	/**
	 * 属性说明行的颜色 例如:HSSFColor.GREEN.index 默认
	 */
	private short headerColor = HSSFColor.GREEN.index;
