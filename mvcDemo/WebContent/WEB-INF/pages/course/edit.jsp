...
<meta name="description" content="修改系统课程信息">
<meta name="keywords" content="课程，修改课程">
<!-- For iPhone -->
<meta name="msapplication-TileColor" content="#00bcd4">
<meta name="msapplication-TileImage"
	content="<c:url value='/frame/images/favicon/mstile-144x144.png'/>">
<!-- For Windows Phone -->
<title>教学管理系统-修改课程</title>
<!-- Favicons-->
<link rel="icon"
	...
	<div id="input-fields" class="row">
		<div class="col s12 z-depth-4 card-panel">
			<form class="col s12" id="editForm" name="editForm" method="post"
				action="<c:url value='/course/update.do'/>">
				...
				<div class="row margin">
					<div class="input-field col s12">
						<i class="mdi-av-my-library-books prefix"></i> <label
							for="coursename" class="center-align">课程名：</label> <input
							type="text" placeholder="${course.name}" id="coursename"
							name="name" value="${course.name}" class="validate">
					</div>
				</div>
				<div class="row">
					<div class="input-field col s12">
