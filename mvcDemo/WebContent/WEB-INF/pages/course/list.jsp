		...
		<div class="container">
			<div style="padding: 5px">
				...
				<ul>
					<li><a
						class="waves-effect waves-light btn cyan accent-4 right"
						href="<c:url value='/course/importExcel.do'/>">导入数据</a></li>
				</ul>
				<ul>
					<li><a
						class="waves-effect waves-light btn cyan accent-4 right"
							...
							<c:forEach items="${courseList}" var="item" varStatus="s">
								<tr>
									...
									<td align="center" valign="middle"><a
										...
										href="<%=basePath %>/course/enterEdit/${item.id}.do">修改</a>
										&nbsp;&nbsp;&nbsp; <a
										class="waves-effect waves-light btn cyan accent-4 left"
										href="<%=basePath %>/course/deleteCourse/${item.id}.do">删除</a>
										&nbsp;&nbsp;&nbsp; <a
										class="waves-effect waves-light btn cyan accent-4 left"
										href="<%=basePath %>/course/enterDetail/${item.id}.do">详细</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
