...
public class StudentController extends BaseController<Student> {
	...
	public void exportExcel(HttpServletRequest request,
		...
		try {
			...
			ExcelTitleVo  title = new ExcelTitleVo("学生列表", "导出人:"+ (String) map.get("userName"), "导出信息");
			workbook = ExcelExportUtil.exportExcel(title, Student.class, students);
...
/*	*//**
	...
	public void exportStatisticsTemplate(Student student, HttpServletRequest request,
	...
	public void exportExcelTemplate(Student student, HttpServletRequest request,
		...
		try {
			...
			// 产生工作簿对象
			Workbook workbook = null;
			ExcelTitleVo  title = new ExcelTitleVo("学生信息模板", "导出人:"+ (String) map.get("userName"), "导出信息");
...
/*
	...
	public MessageDto importExcel(HttpServletRequest request,
		...
		for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
			...
			params.setSaveUrl(PropertiesUtil.getInstance().getPropertiesValue("file.upload.path")+"/excelUpload");
