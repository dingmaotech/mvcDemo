...
public class TeacherController extends BaseController<Teacher> {
	...
	public void exportExcel(HttpServletRequest request,
		...
		try {
			...
			ExcelTitleVo  title = new ExcelTitleVo("教师列表", "导出人:"+ (String) map.get("userName"), "导出信息");
			workbook = ExcelExportUtil.exportExcel(title, Teacher.class, teachers);
	...
	public void exportExcelTemplate(Teacher teacher, HttpServletRequest request,
		...
		try {
			...
			// 产生工作簿对象
			Workbook workbook = null;
			ExcelTitleVo  title = new ExcelTitleVo("教师信息模板", "导出人:"+ (String) map.get("userName"), "导出信息");
