...
public final class ExcelExportOfTemplateUtil {
	...
	public static Workbook exportExcel(TemplateExportParam params,
		...
		return createSheetInUserModel2FileByTemplate(params, clazz,
				data, map);
	}
	...
	private static Workbook createSheetInUserModel2FileByTemplate(
			TemplateExportParam params, Class<?> clazz,
			Collection<?> data, Map<String, Object> map) {
		// step 1. 判断模板的地址
	 ...
	 *@date   2013-11-11
	 */
	private static Workbook getCloneWorkBook(TemplateExportParam params) throws Exception {
		Workbook wb = null;
	...
	private static void addDataToSheet(TemplateExportParam params,
			Class<?> clazz, Collection<?> data, Sheet sheet,
	...
	private static void createImageCell(Drawing patriarch,
			ExcelExportVo entity, Row row, int i, String field,
